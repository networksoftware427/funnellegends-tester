    ...
    <div className="flex-1 bg-gray-50 text-gray-900 overflow-y-auto flex flex-col">
      ...
      <div className="bg-green-600 backdrop-blur-md border-b border-green-700 px-6 py-4 flex flex-col md:flex-row md:items-center justify-between gap-4 sticky top-0 z-20 shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-xl font-black tracking-tight text-white">BountyPack</h2>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button 
            ...
            className={`px-3.5 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-2 border ${activeTab === 'portal' ? 'bg-white text-green-700 border-green-200 shadow-lg shadow-green-600/20' : 'bg-green-700 text-green-100 hover:text-white border-green-600'}`}
          >
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-2 flex items-center gap-1 overflow-x-auto no-scrollbar shrink-0">
        ...
        <button 
          ...
          className={`px-4 py-2 rounded-xl text-xs font-extrabold transition-all flex items-center gap-2 shrink-0 ${activeTab === 'ledger' ? 'bg-indigo-600 text-white shadow-md shadow-indigo-600/30' : 'text-slate-400 hover:text-slate-200'}`}
        >
      ...
      <div className="p-6 flex-1 max-w-[1600px] w-full mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-2 relative overflow-hidden shadow-xl">
                ...
                <div>
                  <p className="text-xs text-slate-400 font-medium">Referred Gross Sales</p>
                  <h3 className="text-2xl font-black text-slate-100">${totalGrossRevenue.toLocaleString()}</h3>
                </div>
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-2 relative overflow-hidden shadow-xl">
                ...
                <div>
                  <p className="text-xs text-slate-400 font-medium">Total Commissions Earned</p>
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-2 relative overflow-hidden shadow-xl">
                ...
                <div>
                  <p className="text-xs text-slate-400 font-medium">Pending Payout Balance</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-5 shadow-xl">
                <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-base font-bold text-slate-100">2-Tier Commission Distribution</h3>
                  </div>
                  <span className="text-xs text-slate-400 font-mono">Sticky Cookies Active (60 Days)</span>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/80 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-bold text-slate-300">Tier 1 Direct Referrals</span>
                    ...
                    <p className="text-[11px] text-slate-400">Direct sales attributed to primary partner tracking links.</p>
                  </div>

                  <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/80 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-bold text-slate-300">Tier 2 Sub-Affiliate Network</span>
                    ...
                    <p className="text-[11px] text-slate-400">Passive income earned by parent affiliates recruiting sub-partners.</p>
                  </div>
                </div>
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">Manage partner applications, commission tiers and promo assets.</p>
                </div>

                <div className="space-y-2.5">
                  <button 
                    onClick={() => setActiveTab('roster')}
                    className="w-full py-2.5 px-4 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-xl text-xs font-bold flex items-center justify-between border border-slate-700 transition-all"
                  >
                    <div className="flex items-center gap-2">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4 shadow-xl">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-base font-bold text-slate-100">Recent Referred Transactions</h3>
                  <p className="text-xs text-slate-400">Live sales stream linked to affiliate tracking codes.</p>
                </div>
                <button 
                  onClick={() => setActiveTab('ledger')}
                  ...
                  <tbody className="divide-y divide-slate-800/60 font-medium">
                    {transactions.slice(0, 5).map(tx => (
                      <tr key={tx.id} className="hover:bg-slate-800/40 transition-colors">
                        ...
                        <td className="py-3 px-3 text-slate-200">{tx.customerName}</td>
                        <td className="py-3 px-3 text-slate-400">{tx.productName}</td>
                        <td className="py-3 px-3 font-bold text-slate-200">${tx.amount}</td>
                        <td className="py-3 px-3">
                          <span className="px-2 py-0.5 bg-slate-800 border border-slate-700 text-amber-300 rounded font-mono text-[11px] font-bold">
                            {tx.affiliateCode}
                          </span>
                        </td>
                        <td className="py-3 px-3">
              ...
              <div className="flex items-center gap-1.5 flex-wrap">
                {(['All', 'Approved', 'Pending', 'VIP', 'Denied'] as const).map(status => (
                  <button 
                    ...
                    className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all ${rosterFilter === status ? 'bg-indigo-600 text-white shadow-md' : 'bg-slate-950 text-slate-400 hover:text-slate-200 border border-slate-800'}`}
                  >
                    {status}
                    ...
                    return (
                      <tr key={aff.id} className="hover:bg-slate-800/40 transition-colors">
                        ...
                        <td className="py-3.5 px-4">
                          <div className="flex items-center gap-3">
                            <img src={aff.avatar} alt={aff.name} className="w-9 h-9 rounded-full object-cover border border-slate-700" />
                            <div>
                        ...
                        <td className="py-3.5 px-4">
                          <button 
                            ...
                            className="px-2.5 py-1 bg-slate-950 border border-slate-800 hover:border-amber-500/50 text-amber-300 rounded font-mono text-xs font-bold flex items-center gap-1.5 group"
                          >
                        ...
                        {/* Plan */}
                        <td className="py-3.5 px-4">
                          <span className="text-slate-300 font-medium">{assignedPlan?.name || 'Standard'}</span>
                        </td>

                        {/* Sales / Rev */}
                        <td className="py-3.5 px-4 font-mono">
                          <div className="font-bold text-slate-200">{aff.totalSalesCount} sales</div>
                          <div className="text-[11px] text-slate-400">${aff.grossRevenue.toLocaleString()} gross</div>
                        </td>

                        {/* Earned / Paid */}
                        <td className="py-3.5 px-4 font-mono">
                          <div className="font-bold text-emerald-400">${aff.commissionEarned.toLocaleString(undefined, { minimumFractionDigits: 2 })}</div>
                          <div className="text-[11px] text-slate-400">${aff.commissionPaid.toLocaleString(undefined, { minimumFractionDigits: 2 })} paid</div>
                        </td>

                        {/* Payout method */}
                        <td className="py-3.5 px-4">
                          <span className="px-2 py-0.5 bg-slate-950 text-slate-300 rounded text-[11px] border border-slate-800 font-mono">
                            {aff.payoutMethod}
                          </span>
                        </td>
                        ...
                        <td className="py-3.5 px-4 text-right space-x-1.5">
                          ...
                          {aff.status === 'Pending' && (
                            <>
                              ...
                              <button 
                                ...
                                className="px-2.5 py-1 bg-rose-600/20 hover:bg-rose-600 text-rose-400 hover:text-white rounded-lg text-xs font-bold"
                              >
                                Reject
                              </button>
                            </>
                          ...
                          {aff.status === 'Approved' && (
                            <button 
                              ...
                              className="px-2.5 py-1 bg-purple-600/20 hover:bg-purple-600 text-purple-300 hover:text-white rounded-lg text-xs font-bold border border-purple-500/30"
                            >
                              Make VIP
                            </button>
                          )}
        ...
        {activeTab === 'plans' && (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-xl font-black text-slate-100">Commission Tiers & Plans</h3>
                <p className="text-xs text-slate-400">Configure 1st-Tier direct payouts, 2nd-Tier sub-affiliate kickbacks, product overrides & sticky cookies.</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {plans.map(plan => (
                <div key={plan.id} className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-5 shadow-xl hover:border-indigo-500/50 transition-all relative flex flex-col justify-between">
                  {plan.isDefault && (
                  ...
                  <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/80 space-y-3">
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-slate-400 font-medium">1st-Tier Direct Payout:</span>
                    ...
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-slate-400 font-medium">2nd-Tier Sub-Kickback:</span>
                    ...
                    <div className="flex items-center justify-between text-xs border-t border-slate-800 pt-2">
                      <span className="text-slate-400 font-medium">Sticky Cookie Duration:</span>
                      <span className="font-bold text-amber-300 font-mono">{plan.stickyCookieDays} Days</span>
                    </div>

                    <div className="flex items-center justify-between text-xs">
                      <span className="text-slate-400 font-medium">Refund Holdback Period:</span>
                      <span className="font-bold text-slate-300 font-mono">{plan.holdbackDays} Days</span>
                    </div>
                  </div>
                  ...
                  {plan.productOverrides && plan.productOverrides.length > 0 && (
                    <div className="space-y-2">
                      <span className="text-[11px] font-bold text-slate-300 uppercase font-mono">Custom Product Overrides ({plan.productOverrides.length})</span>
                      <div className="space-y-1.5">
                        {plan.productOverrides.map((ov, idx) => (
                          <div key={idx} className="p-2 bg-slate-950 rounded-lg text-[11px] flex items-center justify-between border border-slate-800/60">
                            <span className="text-slate-300 truncate max-w-[180px]">{ov.productName}</span>
                  ...
                  <div className="pt-2 flex items-center gap-2">
                    <button className="w-full py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-xl text-xs font-bold border border-slate-700">
                      Edit Plan Rules
                    </button>
                  </div>
                </div>
        ...
        {activeTab === 'ledger' && (
          <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <h3 className="text-xl font-black text-slate-100">Referred Sales Ledger</h3>
                <p className="text-xs text-slate-400">Audit sales attribution, 2-tier commission split allocations, and holdback statuses.</p>
              </div>
            </div>
                ...
                <tbody className="divide-y divide-slate-800/60">
                  {transactions.map(tx => (
                    <tr key={tx.id} className="hover:bg-slate-800/40 transition-colors">
                      ...
                      <td className="py-3.5 px-4">
                        <div className="font-bold text-slate-200">{tx.customerName}</div>
                        <div className="text-[11px] text-slate-400">{tx.customerEmail}</div>
                      </td>
                      <td className="py-3.5 px-4">
                        <div className="font-medium text-slate-200">{tx.productName}</div>
                        <div className="text-[10px] text-indigo-400 font-mono">{tx.funnelName}</div>
                      </td>
                      <td className="py-3.5 px-4 font-bold text-slate-200 font-mono">${tx.amount}</td>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-2">
                <span className="text-xs text-slate-400">Total Unpaid Owed</span>
                <h3 className="text-2xl font-black text-amber-400">${totalPendingPayout.toLocaleString(undefined, { minimumFractionDigits: 2 })}</h3>
                <p className="text-[11px] text-slate-400">Commissions past holdback window</p>
              </div>

              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-2">
                <span className="text-xs text-slate-400">Minimum Payout Rule</span>
                <h3 className="text-2xl font-black text-indigo-400">${settings.minimumPayoutAmount}.00</h3>
                <p className="text-[11px] text-slate-400">Threshold required before payout</p>
              </div>

              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-2">
                <span className="text-xs text-slate-400">Lifetime Paid Out</span>
                ...
                <p className="text-[11px] text-slate-400">Processed via MassPay & CSV</p>
              </div>
            </div>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4 shadow-xl">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  <h3 className="text-base font-bold text-slate-100">Ready Payout Queue</h3>
                  <p className="text-xs text-slate-400">Select partners to issue batch payouts or export CSV file.</p>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <button 
                    ...
                    className={`px-4 py-2 rounded-xl text-xs font-extrabold flex items-center gap-2 shadow-lg transition-all ${selectedPayoutIds.length > 0 ? 'bg-indigo-600 text-white shadow-indigo-600/30 hover:bg-indigo-500' : 'bg-slate-800 text-slate-500 cursor-not-allowed'}`}
                  >
                    ...
                    {affiliates.map(aff => {
                      ...
                      return (
                        <tr key={aff.id} className="hover:bg-slate-800/40 transition-colors">
                          ...
                          <td className="py-3.5 px-4 font-bold text-slate-100">{aff.name} ({aff.affiliateCode})</td>
                          <td className="py-3.5 px-4 font-mono text-slate-300">{aff.payoutMethod}</td>
                          <td className="py-3.5 px-4 font-mono text-indigo-400">{aff.payoutEmail}</td>
                          <td className="py-3.5 px-4 font-mono text-slate-400">${aff.commissionEarned.toFixed(2)}</td>
                          <td className="py-3.5 px-4 font-mono text-slate-400">${aff.commissionPaid.toFixed(2)}</td>
                          <td className="py-3.5 px-4 font-mono font-black text-amber-400 text-sm">
                            ${unpaid.toFixed(2)}
                          </td>
                          <td className="py-3.5 px-4">
                            {unpaid <= 0 ? (
                              <span className="px-2 py-0.5 bg-slate-950 text-slate-500 rounded text-[10px]">ALL SETTLED</span>
                            ) : meetsThreshold ? (
                              ...
                              <span className="px-2 py-0.5 bg-slate-950 text-amber-400 border border-slate-800 rounded text-[10px]">BELOW $50 MIN</span>
                            )}
                          </td>
                        </tr>
                      );
        ...
        {activeTab === 'promo_assets' && (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-xl font-black text-slate-100">Promotional Swipes & Asset Vault</h3>
                <p className="text-xs text-slate-400">High-converting email copy, banner graphic embed codes & social post swipes for your affiliates.</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {promoMaterials.map(item => (
                <div key={item.id} className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4 shadow-xl flex flex-col justify-between">
                  <div className="space-y-3">
                    ...
                    {item.imageUrl && (
                      <div className="rounded-xl overflow-hidden border border-slate-800 h-36">
                        <img src={item.imageUrl} alt={item.title} className="w-full h-full object-cover" />
                      </div>
                    )}

                    <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 max-h-48 overflow-y-auto">
                      <pre className="text-[11px] text-slate-300 whitespace-pre-wrap font-mono">{item.content}</pre>
                    </div>
                  </div>
                  ...
                  <div className="pt-2 flex items-center gap-2">
                    <button 
                      ...
                      className="w-full py-2.5 bg-slate-800 hover:bg-indigo-600 text-slate-200 hover:text-white rounded-xl text-xs font-extrabold flex items-center justify-center gap-2 transition-all"
                    >
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                  <div className="space-y-2 max-w-2xl">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-slate-400 font-mono">Ends Sept 30, 2026</span>
                    </div>

                    <h3 className="text-2xl sm:text-3xl font-black text-white">{c.title}</h3>
                    <p className="text-sm text-slate-300">{c.description}</p>
                  </div>

                  <div className="bg-slate-950/80 p-5 rounded-2xl border border-amber-500/30 space-y-2 text-center shrink-0">
                    <span className="text-xs text-slate-400 font-bold uppercase font-mono">Grand Prize Pool</span>
                              ...
                              <tr key={aff.id} className="hover:bg-slate-800/40 transition-colors">
                                ...
                                <td className="py-3 px-3">
                                  <div className="flex items-center gap-2.5">
                                    ...
                                    <span className="font-bold text-slate-100">{aff.name}</span>
                                  </div>
                                </td>

                                <td className="py-3 px-3 font-mono text-slate-300 font-bold">{aff.totalSalesCount} Sales</td>
                                ...
                                <td className="py-3 px-3 w-48">
                                  <div className="space-y-1">
                                    ...
                                    <span className="text-[10px] text-slate-400 font-mono">{percent}% of target</span>
                                  </div>
                                </td>
        ...
        {activeTab === 'portal' && (
          <div className="space-y-6">
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs text-slate-300 font-bold">Impersonate Partner:</span>
                <select 
                  value={portalAffiliateId}
                  onChange={(e) => setPortalAffiliateId(e.target.value)}
                  className="bg-slate-950 border border-amber-500/40 text-amber-300 text-xs rounded-xl px-3 py-1.5 font-bold focus:outline-none"
                >
                  {affiliates.map(a => (
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 space-y-8 shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-extrabold text-white">Welcome Back, {activePortalUser.name}!</h3>
                    <p className="text-xs text-slate-400">Partner Code: <strong className="text-amber-300 font-mono">{activePortalUser.affiliateCode}</strong> • Plan: <strong className="text-indigo-400">Standard 40% + 10% 2-Tier</strong></p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-slate-950 p-5 rounded-2xl border border-slate-800 space-y-1">
                  ...
                  <div className="text-2xl font-black text-white">{activePortalUser.totalClicks.toLocaleString()}</div>
                </div>
                ...
                <div className="bg-slate-950 p-5 rounded-2xl border border-slate-800 space-y-1">
                  <span className="text-xs text-slate-400">Total Commissions</span>
                ...
                <div className="bg-slate-950 p-5 rounded-2xl border border-slate-800 space-y-1">
                  <span className="text-xs text-slate-400">Unpaid Payout</span>
              ...
              <div className="bg-slate-950 p-6 rounded-2xl border border-slate-800 space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-base font-bold text-slate-100">Your Custom Affiliate Tracking Link Generator</h4>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="text-xs font-bold text-slate-300 block mb-1">Target Funnel / Product</label>
                    <select 
                  ...
                  <div>
                    <label className="text-xs font-bold text-slate-300 block mb-1">Sub-ID / Campaign Tracking Tag</label>
                    <input 
                      type="text"
                      value={portalSubId}
              ...
              <div className="bg-slate-950 p-6 rounded-2xl border border-slate-800 space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <h4 className="text-base font-bold text-slate-100">Your 2-Tier Sub-Affiliate Network Tree</h4>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {affiliates.filter(a => a.parentAffiliateId === activePortalUser.id).length > 0 ? (
                    affiliates.filter(a => a.parentAffiliateId === activePortalUser.id).map(sub => (
                      <div key={sub.id} className="bg-slate-900 p-4 rounded-xl border border-slate-800 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="font-bold text-slate-200 text-xs">{sub.name}</div>
                            <div className="text-[10px] text-slate-400 font-mono">{sub.totalSalesCount} sales generated</div>
                          </div>
                        </div>
                    ...
                    <div className="col-span-2 text-center py-6 text-xs text-slate-500 bg-slate-900/50 rounded-xl border border-slate-800">
        ...
        {activeTab === 'settings' && (
          <div className="space-y-6 max-w-3xl">
            <div>
              <h3 className="text-xl font-black text-slate-100">BountyPack System Settings</h3>
              <p className="text-xs text-slate-400">Configure global attribution rules, self-referral blocks & payout defaults.</p>
            </div>

            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-6 shadow-xl">
              <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                <div>
                  <h4 className="text-sm font-bold text-slate-100">Auto-Approve Partner Applications</h4>
                  <p className="text-xs text-slate-400">Automatically grant affiliate access upon application submit.</p>
                </div>
                <input 
                  type="checkbox"
              ...
              <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                <div>
                  <h4 className="text-sm font-bold text-slate-100">Self-Referral Commission Protection</h4>
                  <p className="text-xs text-slate-400">Block affiliates from earning commission on their own email purchases.</p>
                </div>
                <input 
                  type="checkbox"
              ...
              <div className="space-y-2 border-b border-slate-800 pb-4">
                <h4 className="text-sm font-bold text-slate-100">Cookie Attribution Priority Mode</h4>
                <div className="grid grid-cols-2 gap-3">
                  <button 
                    onClick={() => setSettings({ ...settings, cookieAttributionMode: 'last_click' })}
                    className={`p-3 rounded-xl border text-xs font-bold text-left transition-all ${settings.cookieAttributionMode === 'last_click' ? 'bg-indigo-600 text-white border-indigo-500 shadow-md' : 'bg-slate-950 text-slate-400 border-slate-800'}`}
                  >
                    <div>Last-Click Priority (Recommended)</div>
                    <div className="text-[10px] text-slate-300 font-normal mt-0.5">Most recent affiliate link gets 100% direct attribution.</div>
                  </button>

                  <button 
                    onClick={() => setSettings({ ...settings, cookieAttributionMode: 'first_click' })}
                    className={`p-3 rounded-xl border text-xs font-bold text-left transition-all ${settings.cookieAttributionMode === 'first_click' ? 'bg-indigo-600 text-white border-indigo-500 shadow-md' : 'bg-slate-950 text-slate-400 border-slate-800'}`}
                  >
                    <div>First-Click Priority</div>
                    <div className="text-[10px] text-slate-300 font-normal mt-0.5">First affiliate link clicked locks lifetime attribution.</div>
                  </button>
                </div>
              </div>

              <div className="space-y-2">
                <h4 className="text-sm font-bold text-slate-100">Default Tracking Domain URL</h4>
                <input 
                  type="text"
      ...
      {isAppModalOpen && selectedAffiliate && selectedAffiliate.applicationAnswers && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl max-w-xl w-full p-6 space-y-6 shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-800 pb-4">
              <div className="flex items-center gap-3">
                <img src={selectedAffiliate.avatar} alt={selectedAffiliate.name} className="w-10 h-10 rounded-full border border-slate-700 object-cover" />
                <div>
                  <h3 className="text-base font-bold text-slate-100">{selectedAffiliate.name} Application</h3>
            ...
            <div className="space-y-4 text-xs">
              <div className="bg-slate-950 p-3.5 rounded-xl border border-slate-800 space-y-1">
                ...
                <p className="text-slate-200">{selectedAffiliate.applicationAnswers.trafficSource}</p>
              </div>

              <div className="bg-slate-950 p-3.5 rounded-xl border border-slate-800 space-y-1">
                <span className="font-bold text-indigo-400">Monthly Audience Reach:</span>
                <p className="text-slate-200 font-mono">{selectedAffiliate.applicationAnswers.monthlyAudience}</p>
              </div>
              ...
              <div className="bg-slate-950 p-3.5 rounded-xl border border-slate-800 space-y-1">
                ...
                <p className="text-slate-200">{selectedAffiliate.applicationAnswers.promotionalMethods}</p>
              </div>
            </div>
      ...
      {isPlanModalOpen && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl max-w-md w-full p-6 space-y-5 shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-800 pb-4">
              <h3 className="text-base font-bold text-slate-100">Create New Commission Plan</h3>
            ...
            <div className="space-y-4">
              <div>
                <label className="text-xs font-bold text-slate-300 block mb-1">Plan Title</label>
                <input 
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-xs font-bold text-slate-300 block mb-1">1st Tier Rate (%)</label>
                  <input 
                    type="number"
                    value={newPlanTier1}
                ...
                <div>
                  <label className="text-xs font-bold text-slate-300 block mb-1">2nd Tier Rate (%)</label>
                  <input 
                    type="number"
                    value={newPlanTier2}
              ...
              <div>
                <label className="text-xs font-bold text-slate-300 block mb-1">Sticky Cookie Duration (Days)</label>
                <input 
                  type="number"
      ...
      {isAddPromoOpen && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl max-w-lg w-full p-6 space-y-5 shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-800 pb-4">
              <h3 className="text-base font-bold text-slate-100">Add Promotional Marketing Asset</h3>
            ...
            <div className="space-y-4">
              <div>
                <label className="text-xs font-bold text-slate-300 block mb-1">Asset Type</label>
                <select 
                  value={newPromoType}
              ...
              {newPromoType === 'email' && (
                <div>
                  <label className="text-xs font-bold text-slate-300 block mb-1">Subject Line</label>
                  <input 
                    type="text"
              ...
              <div>
                <label className="text-xs font-bold text-slate-300 block mb-1">Content / HTML / Swipe Text</label>
                <textarea 
                  rows={6}
