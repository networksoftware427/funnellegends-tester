  ...
  const tools = [
    {
      ...
      desc: "Build ClickFunnels 2-tab structured sections, rows, columns, and elements with real-time CSS variable bindings."
    },
    {
    ...
    <div className="bg-slate-950 text-slate-100 min-h-screen py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-5xl font-black text-white tracking-tight">Every Tool You Need To Scale Without Buying 10+ Apps</h1>
          <p className="text-slate-400 text-sm sm:text-base">Explore the full catalog of enterprise tools pre-loaded into your FunnelLegends account.</p>
        </div>
