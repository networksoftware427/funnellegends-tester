    ...
    <div className="bg-slate-950 text-slate-100 min-h-screen py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="p-8 bg-white border border-emerald-200 rounded-3xl space-y-6 flex flex-col justify-between shadow-sm hover:border-emerald-400 transition-all">
            <div className="space-y-4">
              ...
              <div className="pt-2">
                ...
                <p className="text-[11px] text-emerald-700 font-extrabold mt-1">Then $97/mo • Cancel Anytime</p>
              </div>
          ...
          {/* Plan 2: Pro (Featured) */}
          <div className="p-8 bg-slate-900 border-2 border-emerald-500 rounded-3xl space-y-6 flex flex-col justify-between shadow-2xl relative transform scale-105">
            ...
            <div className="space-y-4 pt-2">
              ...
              <p className="text-xs text-slate-200 font-medium">For scaling agencies and businesses requiring full suite access.</p>
              <div className="pt-2">
          ...
          <div className="p-8 bg-white border border-emerald-200 rounded-3xl space-y-6 flex flex-col justify-between shadow-sm hover:border-emerald-400 transition-all">
            <div className="space-y-4">
              ...
              <div className="pt-2">
                <span className="text-4xl font-black text-slate-900">$0</span>
                <span className="text-xs text-slate-700 font-bold ml-2">For 30 Days</span>
                <p className="text-[11px] text-emerald-700 font-extrabold mt-1">Then $497/mo • Dedicated VIP Support</p>
              </div>
              <ul className="space-y-2.5 text-xs text-slate-800 font-semibold pt-4 border-t border-emerald-100">
