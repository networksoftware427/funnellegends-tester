...
const endTag = "case 'one_click_upsell':";
          ...
          {step === 1 ? (
            <div className="space-y-3 text-left">
              <div>
                ...
                <input type="text" placeholder="John Doe" className="w-full bg-slate-950 border border-slate-800 px-3 py-2 text-xs text-slate-200" style={{ color: props.fieldTextColor || undefined }} />
              </div>
              <div>
                <label className="block text-xs font-semibold mb-1" style={titleStyle}>Email Address</label>
                <input type="email" placeholder="john@example.com" className="w-full bg-slate-950 border border-slate-800 px-3 py-2 text-xs text-slate-200" style={{ color: props.fieldTextColor || undefined }} />
              </div>
              <button 
                onClick={() => setStep(2)} 
            ...
            <div className="space-y-3 text-left">
              ...
              <div className="space-y-2 pt-2">
                ...
                <div className="relative">
                  <input type="text" placeholder="0000 0000 0000 0000" className="w-full bg-slate-950 border border-slate-800 px-3 py-2.5 text-xs pl-10 text-slate-200" style={{ color: props.fieldTextColor || undefined }} />
                  <CreditCard className="w-4 h-4 text-slate-500 absolute left-3 top-2.5" />
                </div>
                <div className="grid grid-cols-2 gap-2">
                  <input type="text" placeholder="MM/YY" className="w-full bg-slate-950 border border-slate-800 px-3 py-2 text-xs text-center text-slate-200" style={{ color: props.fieldTextColor || undefined }} />
                  <input type="text" placeholder="CVC" className="w-full bg-slate-950 border border-slate-800 px-3 py-2 text-xs text-center text-slate-200" style={{ color: props.fieldTextColor || undefined }} />
                </div>
              </div>
